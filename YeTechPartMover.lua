...
local function FLKV_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(FLKV_fake_script)()
local function VZEAID_fake_script() -- FeBToolsGui.LocalScript 
	local script = Instance.new('LocalScript', FeBToolsGui)

	script.Parent.Frame.Active = true
	script.Parent.Frame.Draggable = true
end
coroutine.wrap(VZEAID_fake_script)()
